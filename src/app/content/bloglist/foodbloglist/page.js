...
const imgurl = "https://images3.memedroid.com/images/UPLOADED706/63551be3622b4.jpeg"
...
export default function Page() {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-items-center min-h-screen p-8 pb-20 gap-10 sm:p-20">
            ...
            <h1 style={{ color: '#8c52ff' }} className={`${textstylealt} mb-[100px]`}>Food</h1>

            <img
                src = {imgurl}
                // src="/home/pratiek/Downloads/Blog Website/techblog/public/herpderp.webp"
                alt="Description"
                className="w-[450px] h-auto object-cover rounded-lg"
                />
