...
export default function TravelBlogCard({imgurl, blog_title, blog_date, tag1, tag2, tag3, paragraph}) {

    const textstyle = "kumbh-sans text-[42px] text-center transform hover:scale-110 transition-all ease-in-out hover:font-bold"

    return (
        <>
        <div className="grid grid-cols-[35%_65%] w-[1200px] border-white border-[1px] rounded-lg p-5 mb-10 bg-transparent relative overflow-hidden group"> 
